function Sangle = calRightAnglesSole(uki,nFr)
...
try
    ...
    tmpRO = setRightSoleCS(uki,nFr);
    %つま先
    uki.R1(:,1+4*(nFr-1):4+4*(nFr-1)) = tmpRO(:,1:4);%[tmpRO(:,1) tmpRO(:,2) tmpRO(:,3) tmpRO(:,4)];
    %前足部
    uki.R2(:,1+4*(nFr-1):4+4*(nFr-1)) = tmpRO(:,5:8);%[tmpRO(:,5) tmpRO(:,6) tmpRO(:,7) tmpRO(:,8)];
    %中足部
    uki.R3(:,1+4*(nFr-1):4+4*(nFr-1)) = tmpRO(:,9:12);%[tmpRO(:,9) tmpRO(:,10) tmpRO(:,11) tmpRO(:,12)];
    %後足部
    uki.R4(:,1+4*(nFr-1):4+4*(nFr-1)) = tmpRO(:,13:16);%[tmpRO(:,13) tmpRO(:,14) tmpRO(:,15) tmpRO(:,16)];
    %かかと部
    uki.R5(:,1+4*(nFr-1):4+4*(nFr-1)) = tmpRO(:,17:20);%[tmpRO(:,17) tmpRO(:,18) tmpRO(:,19) tmpRO(:,20)];
    ...
    Ro_mat6 = uki.R2(:,1+4*(nFr-1):4+4*(nFr-1)) \ uki.R4(:,1+4*(nFr-1):4+4*(nFr-1));
